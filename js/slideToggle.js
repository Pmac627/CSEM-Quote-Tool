...
(function () {
    ...
    ST.prototype = {
        ...
        slideCSS: function () {
            var el = this.el,
                that = this;
            // EDIT 2/1/14 - Pat MacMannis
            el.style[ST.vprefix] = 'height ' + this.speed + 'ms linear';
            // END EDIT

            if (this.visible()) {
                //el.style[ST.vprefix] = 'height ' + this.speed + 'ms linear, color ' + (this.speed/2) + 'ms linear';
                setTimeout(function () {
                    el.style.height = '0';
                    // EDIT 2/1/14 - Pat MacMannis
        ...
        findAutoHeight: function () {
            ...
            // EDIT 2/1/14 - Pat MacMannis
            // el.style.cssText = oldCssText + 'display:block;position:absolute;top:-999px;height:auto;width:' + w + 'px';
            el.style.cssText = oldCssText + 'display:block;position:absolute;top:-999px;height:auto;width:' + w + 'px;padding:0;';
